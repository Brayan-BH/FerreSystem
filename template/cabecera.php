    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <ul class="navbar-nav mr-auto ">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="nosotros.php"><i class="fas fa-users"></i> NOSOTROS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="productos.php"><i class="fas fa-store"></i> PRODUCTOS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="mostrarcarrito.php"><i class="fas fa-shopping-cart"></i> CARRITO(
                ...
                <li class="nav-item">
                    <a class="nav-link" href="administrador/index.php" id="parpadeo"><i class="fas fa-lock"></i> Login</a>
                </li>
            </ul>
        </div>
        </div>
